...
uint8_t kdf_key[CONFIG_KDF_KEY_MAX_SIZE] = {0x35, 0x0a , 0xb9 , 0x76 , 0x36 , 0x5a , 0x37 , 0xee  , 0x84 , 0x70 , 0xad , 0x8a , 0xe0 , 0xf7 , 0x0e , 0xe8};
...
int main(){
    ...
    if (uid[uid_len-1]=='\n') uid_len--;
    mbedtls_pkcs5_pbkdf2_hmac_ext(MBEDTLS_MD_SHA1, uid, uid_len, kdf_key, sizeof(kdf_key), CONFIG_KDF_ROUNDS, sizeof(otp_key), otp_key);
